...
- [ ] T004 Incluir tracking de `Meta.status` e `Meta.status_resultado` em `apps/audit/signals.py` (novo `META_TRACKED_FIELDS` + connect nos receivers existentes) para AuditLog append-only com `audit_actor`
