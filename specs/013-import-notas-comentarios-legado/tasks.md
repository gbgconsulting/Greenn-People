...
- [ ] T023 [US3] Validar US3 via `specs/013-import-notas-comentarios-legado/quickstart.md` C1 + C7 + C8 + C9 (`pytest tests/test_import_notas_comentarios_legado.py -q` verde; CI não lê `raw/`); confirmar denylist diff vazio
